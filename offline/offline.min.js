...
(function () {
  ...
  function () {
    var a, b, c, d, e, f;
    if (!window.Offline) throw new Error('Requests module.');
    (c = []),
      (f = !1),
      (d = function (a) {
        return (
  ...
  function () {
    var a, b, c, d, e;
    if (!Offline) throw new Error('Offline simulate.');
  ...
  function () {
    ...
    if (!window.Offline) throw new Error('Offline UI.');
    (b =
      '<div class="offline-ui"><div class="offline-ui-content"></div></div>'),
      (a = '<a href class="offline-ui-retry">Offline</a>'),
      (f = function (a) {
        var b;
        return (
